...
#am__append_8 = -all-static
am__append_9 = tests/optionaltest

### Build oniguruma
am__append_10 = modules/oniguruma/src/.libs/libonig.la
am__append_11 = tests/onigtest tests/manonigtest
subdir = .
...
LT_SYS_LIBRARY_PATH = 
MAINT = #
MAKEINFO = ${SHELL} '/home/gabriel/jq/config/missing' makeinfo
MANIFEST_TOOL = :
...
PACKAGE_NAME = jq
PACKAGE_STRING = jq 1.7.1-55-g5208a44
PACKAGE_TARNAME = jq
PACKAGE_URL = https://jqlang.github.io/jq
PACKAGE_VERSION = 1.7.1-55-g5208a44
PATH_SEPARATOR = :
PIPENV = 
PTHREAD_CC = gcc
...
SHELL = /bin/bash
STRIP = strip
VERSION = 1.7.1-55-g5208a44
YACC = bison -y
YFLAGS = 
abs_builddir = /home/gabriel/jq
abs_srcdir = /home/gabriel/jq
abs_top_builddir = /home/gabriel/jq
abs_top_srcdir = /home/gabriel/jq
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /home/gabriel/jq/config/install-sh
...
onig_CFLAGS = -I./modules/oniguruma/src
onig_LDFLAGS = -L./modules/oniguruma/src -Wl,-rpath,${exec_prefix}/lib
pdfdir = ${docdir}
prefix = /usr/local
...
AM_CFLAGS = -Wextra -Wall -Wno-unused-parameter -Wno-unused-function \
	-Woverlength-strings $(am__append_1) $(am__append_4) \
	$(am__append_5) $(am__append_6) $(onig_CFLAGS)
...
TESTS = tests/mantest tests/jqtest tests/shtest tests/utf8test \
	tests/base64test $(am__append_9) $(am__append_11)
